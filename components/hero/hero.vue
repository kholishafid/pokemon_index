...
<template>
  <div
    class="w-full min-h-[8rem] sm:min-h-[10rem] rounded-lg p-4 sm:p-6 md:p-8 flex items-center bg-white/5 mb-3 md:mb-6 overflow-hidden relative gradient md:min-h-[14rem] cursor-pointer rela"
  ...
  >
    ...
    <div
      class="absolute right-5 top-1/2 -translate-y-1/2 md:right-8 px-4 sm:px-6 md:px-8"
    >
